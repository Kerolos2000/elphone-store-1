...
<body class="custom-scrollbar" id="Samsung">
                        ...
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="Dropdown">
                                    ...
                                    <li><a class="dropdown-item active" href="Samsung.php">Samsung</a></li>
            ...
            <div class="row d-flex justify-content-center ">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mt-2 mb-3" style="width: 18rem;">
                    <div class="card text-center">
                        <div class="card-body">
                            <img src="../img/i2.png" class="img-fluid">
