                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="cart.php" class="nav-link active"><i class="fa-solid fa-cart-shopping"></i></a>
                            </li>
            ...
            <div class="row">
                <table id="table" class="table table-bordered table-dark">
                    ...
                    <tbody  class="text-center">
                        <tr>
                            <td><button class="remove"><i class="fa-regular fa-trash-can"></i></button></td>
                            <td><img class="x2" src="../img/i1.jpg"></td>
                            <td><h6>iphone 13 pro max</h6></td>
                            <td><input type="text" class="price" value="22" disabled></input></td>
                            <td><input type="number" class="quantity" value="1"></input></td>
                            <td><h6 class="total"></h6></td>
