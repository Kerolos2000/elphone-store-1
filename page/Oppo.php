...
<body class="custom-scrollbar" id="Apple">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle active" href="#" id="Dropdown" role="button"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="Dropdown">
                                    ...
                                    <li><a class="dropdown-item active" href="Oppo.php">oppo</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="Dropdown">
                                    ...
                                    <li><a class="dropdown-item" href="login.php">sign in / sign out</a></li>
                                </ul>
                            </li>
    ...
    <!-- main section -->
    <section id="oppo-main">
        <div class="container mt-4 mb-4">
            <div class="row d-flex justify-content-center ">

                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mt-2 mb-3"style="width: 18rem;">
                    <div class="card text-center">
                        <div class="card-body">
                            <img src="../img/i3.png" class="img-fluid">
                            <h5 class="card-title">oppo reno 7 pro</h5>
