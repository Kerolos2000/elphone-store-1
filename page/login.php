                                ...
                                <form action=""
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-outline form-white mb-3 col-12">
                                            ...
                                            <div class="invalid-tooltip">Make sure to write the password</div>
                                        </div>
                                        <div>
                                        <button value="signup"
                                            class="mouse-cursor-gradient-tracking  px-5 mt-3 text-center" name="login"
                                            data-testid="royal_signup_button" type="submit">login</button>
                                    </div>
                                    <div class="mt-3">
                                        <a class="c1" href="signup.php">Log in</a>
                                    </div>
                            </div>
                            </form>
                        </div>
